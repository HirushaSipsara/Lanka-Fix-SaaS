 ...
 * - @RestController, @RequestMapping("/api/admin") annotations
 ...
 * - GET /api/admin/stats — Platform statistics (total users, requests, etc.)
 * - All endpoints require ADMIN role
 * - All endpoints return ApiResponse
 *
 * Purpose:
 * Admin-only endpoints for user management and platform oversight.
 */
