 ...
 * - @Entity, @Table(name = "reviews") annotations
 * - Fields:
 * - Long id — @Id, @GeneratedValue
 * - ServiceRequest request — @ManyToOne, the completed request being reviewed
 * - User reviewer — @ManyToOne, the user leaving the review (seeker)
 * - User reviewee — @ManyToOne, the user being reviewed (worker)
