 ...
 * imageUrl — URL or file path of the uploaded image - LocalDateTime uploadedAt -
 * Lombok: @Data, @NoArgsConstructor, @AllArgsConstructor
 *
 * <p>Purpose: Allows seekers to attach photos to their service requests (e.g., a photo of the
 * broken pipe, the wall that needs painting).
 */
