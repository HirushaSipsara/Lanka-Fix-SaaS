 ...
 * - Interface extending JpaRepository<VerificationSubmission, Long>
 ...
 * findByStatusOrderBySubmittedAtAsc(VerificationStatus status)
 *
 * Purpose:
 * Data access for verification submissions — supports filtering by status
